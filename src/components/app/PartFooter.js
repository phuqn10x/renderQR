...
const PartFooter = () => (
    <div className="Qr-titled">
        <div className="Qr-Centered Qr-footer note-font">
            ...
            {/*                     target="_blank">隐私政策</LinkTrace><span*/}
            {/*        className="gray">&ensp;丨&ensp;</span></span>*/}
            {/*    <span><LinkTrace href="https://www.yuque.com/qrbtf/docs/terms" rel="noopener noreferrer"*/}
            {/*                     target="_blank">使用条款</LinkTrace><span*/}
            {/*        className="gray">&ensp;丨&ensp;</span></span>*/}
            {/*    <span><LinkTrace href="https://www.yuque.com/qrbtf/docs/contact" rel="noopener noreferrer"*/}
            {/*                     target="_blank">*/}
            {/*        联系我们</LinkTrace><span className="gray">&ensp;丨&ensp;</span></span>*/}
            {/*    <span><LinkTrace href="https://www.yuque.com/qrbtf/docs/api" rel="noopener noreferrer"*/}
            {/*                     target="_blank">*/}
            ...
            {/*                     target="_blank">mdnice 公众号排版</LinkTrace><span*/}
            {/*        className="gray">&ensp;丨&ensp;</span></span>*/}
            {/*    <span><LinkTrace href="https://urlify.cn/" rel="noopener noreferrer"*/}
            {/*                     target="_blank">Urlify 短链接</LinkTrace><span*/}
            {/*        className="gray">&ensp;丨&ensp;</span></span>*/}
            {/*    <span><LinkTrace href="https://imgkr.com/" rel="noopener noreferrer"*/}
            {/*                     target="_blank">imgkr 图壳图床</LinkTrace><span*/}
            {/*        className="gray">&ensp;丨&ensp;</span></span>*/}
            ...
            <div className="Gray">
                Copyright © {currentYear} phudeptrai.com。<br/>
